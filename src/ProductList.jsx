                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button className="product-button" style={{ backgroundColor : addedToCart[plant.name] ? "grey" : "#4CAF50"}} disabled={addedToCart[plant.name] ? true : false} onClick={() => handleAddToCart(plant)}> Add to Cart </button>
                                    </div>
                                ))}
                            </div>
                        </div>
